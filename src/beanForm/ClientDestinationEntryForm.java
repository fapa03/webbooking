...
public class ClientDestinationEntryForm extends ActionForm {
	...
	private String regimenFiscalDes = null;
	private String regimenFiscalId = null;
	private String usoCfdiDes = null;
	private String usoCfdiId = null;
	private String genericRFC = "";
	private String validRFC = "N";
	...
	private CatClntFiscDTO datosFiscales = null;
	private CatClntFiscDTO datosFiscalesTmp = null;
	private String datosFiscalesString = null;
	private String datosFiscalesTmpString = null;
	private String tieneCredito = null;
	private String validFiscal = "N";
	private String currRFC="";
	private String currValFlag="";
	
	private String bloqueaCodCliente = "";
	
	private boolean fastClntCap = false;
	...
	/**
	 * @return the regimenFiscalDes
	 */
	public String getRegimenFiscalDes() {
		return regimenFiscalDes;
	}

	/**
	 * @param regimenFiscalDes the regimenFiscalDes to set
	 */
	public void setRegimenFiscalDes(String regimenFiscalDes) {
		this.regimenFiscalDes = regimenFiscalDes;
	}

	/**
	 * @return the regimenFiscalId
	 */
	...
	/**
	 * @param regimenFiscalId the regimenFiscalId to set
	 */
	...
	/**
	 * @return the usoCfdiDes
	 */
	public String getUsoCfdiDes() {
		return usoCfdiDes;
	}

	/**
	 * @param usoCfdiDes the usoCfdiDes to set
	 */
	public void setUsoCfdiDes(String cfdiUseDes) {
		this.usoCfdiDes = cfdiUseDes;
	}

	/**
	 * @return the usoCfdiId
	 */
	public String getUsoCfdiId() {
		return usoCfdiId;
	}

	/**
	 * @param usoCfdiId the usoCfdiId to set
	 */
	public void setUsoCfdiId(String cfdiUseId) {
		this.usoCfdiId = cfdiUseId;
	}

	/**
	 * @return the genericRFC
	 */
	public String getGenericRFC() {
		return genericRFC;
	}

	/**
	 * @param genericRFC the genericRFC to set
	 */
	public void setGenericRFC(String genericRFC) {
		this.genericRFC = genericRFC;
	}

	/**
	 * @return the validRFC
	 */
	public String getValidRFC() {
		return validRFC;
	}

	/**
	 * @param validRFC the validRFC to set
	 */
	public void setValidRFC(String validRFC) {
		this.validRFC = validRFC;
	}

	/**
	 * @return the datosFiscales
	 */
	public CatClntFiscDTO getDatosFiscales() {
	...
	public void setDatosFiscales(String datosFiscales) {
		...
		try {
			this.datosFiscales = mapper.readValue(datosFiscales, CatClntFiscDTO.class);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	/**
	 * @return the datosFiscalesString
	 */
	public String getDatosFiscalesString() {
		return datosFiscalesString;
	}

	/**
	 * @param datosFiscalesString the datosFiscalesString to set
	 */
	public void setDatosFiscalesString(String datosFiscalesString) {
		this.datosFiscalesString = datosFiscalesString;
	}
	...
	/**
	 * @return the datosFiscalesTmp
	 */
	public CatClntFiscDTO getDatosFiscalesTmp() {
		return datosFiscalesTmp;
	}

	/**
	 * @param datosFiscalesTmp the datosFiscalesTmp to set
	 */
	public void setDatosFiscalesTmp(String datosFiscales) {
		ObjectMapper mapper = new ObjectMapper();
		try {
			this.datosFiscalesTmp = mapper.readValue(datosFiscales, CatClntFiscDTO.class);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	/**
	 * @return the datosFiscalesTmpString
	 */
	public String getDatosFiscalesTmpString() {
		return datosFiscalesTmpString;
	}

	/**
	 * @param datosFiscalesTmpString the datosFiscalesTmpString to set
	 */
	public void setDatosFiscalesTmpString(String datosFiscalesTmpString) {
		this.datosFiscalesTmpString = datosFiscalesTmpString;
	}
    ...
    /**
     * @return String return the currRFC
     */
    public String getCurrRFC() {
        return currRFC;
    }

    /**
     * @param currRFC the currRFC to set
     */
    public void setCurrRFC(String currRFC) {
        this.currRFC = currRFC;
    }


    /**
     * @return String return the currValFlag
     */
    public String getCurrValFlag() {
        return currValFlag;
    }

    /**
     * @param currValFlag the currValFlag to set
     */
    public void setCurrValFlag(String currValFlag) {
        this.currValFlag = currValFlag;
    }

	/**
	 * @return the fastClntCap
	 */
	public boolean isFastClntCap() {
		return fastClntCap;
	}

	/**
	 * @param fastClntCap the fastClntCap to set
	 */
	public void setFastClntCap(boolean fastClntCap) {
		this.fastClntCap = fastClntCap;
	}
