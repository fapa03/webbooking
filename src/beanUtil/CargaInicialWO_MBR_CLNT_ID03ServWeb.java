...
public class CargaInicialWO_MBR_CLNT_ID03ServWeb {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String query = "SELECT CRTD_BY, WO_ORGN_CLNT_ID, SUBSTR(CRTD_BY,1,LENGTH(CRTD_BY)-2) MBR_ID FROM WEB_ORGN_DEST_CLNT " +
							 "WHERE CRTD_BY LIKE '%WS' AND WO_MBR_CLNT_ID IS NULL "+
