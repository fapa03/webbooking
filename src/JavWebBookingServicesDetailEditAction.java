...
Date					:	25-March-2003
FileName				:	JavWebBookingServicesDetailEditAction.java
SessionVariables		:
Other Used Classes		:
Function Names			:
------------------------------------------------------------*/
...
public class JavWebBookingServicesDetailEditAction extends Action {
	
	public JavWebBookingServicesDetailEditAction() {
		//AAP//AccessLog.Log("JavWebBookingServicesDetailEditAction");
	}
	public ActionForward perform(ActionMapping am, ActionForm af, 
		...
		try{
			...
			if(af instanceof JavWebBookingServicesDetailEditForm){
				...
				if(action !=null && action.equalsIgnoreCase("edit")){
					...
					JavWebBookingServicesDetailAddForm addForm = new JavWebBookingServicesDetailAddForm();
					addForm.cantidad=ssd.cantidad;
					addForm.contenido=ssd.contenido;
					addForm.descripcion=ssd.descripcion;
					addForm.tarifa=ssd.tarifa;
					addForm.peso=ssd.peso;
					addForm.volumen=ssd.volumen;
