package paquetexpress.internal.prepaid.action.valueobject;
...
public class PrepaidValueObject {
	...
	private String shipTypeSEGCurrent = "";
	List<ShipTypeSEG> shippingTypeSEGALL;
	...
	String volL = "32";//JSA01
	String volH = "1";//JSA01
	String volW = "24";//JSA01
	...
	// Agregado el 2 de Enero del 2012 C.Solano cenitsoft
	String zonaExtendida="";
	String ext="";
	...
	public String getShipTypeLabel() {
		return shipTypeLabel;
	}
	public void setShipTypeLabel(String shipTypeLabel) {
		this.shipTypeLabel = shipTypeLabel;
	}
