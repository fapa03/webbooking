...
function getSalesMan() {
	document.forms[0].asigUserName.value = document.forms[0].asigUserName.value.toUpperCase();
	window.document.forms[0].action="lov.do";
...
function getRow(){
	...
	if(rowidflag=='true'){
		...
		window.opener.document.forms[0].cveUserAsig.value = obj2.innerHTML;
		window.opener.document.forms[0].desUserAsig.value =obj1.innerHTML;
		window.close();
	}else{
...
<div id="datadiv" style="WIDTH: 670">
	<table align="left" width="650">
		<tr width="650">
			<td align="left" class="labelText">
			<div style="float:left; padding-top:6px;"><b>Usuario: </b></div>
						<div class="inputV2" style="float:left;">
                        <div class="group">
                            <input type="text" name="asigUserName" size="69" onkeypress="openKeyLov()" class="upper">
...
<div id="data" style="HEIGHT: 159pt; OVERFLOW: auto; WIDTH: 670">
	<table align="left" width="650" class="tablaDetallev2">			
		<tr width="650" class="tablaDetallev2Header">
			<th align="left" width="50"> <b>ID Usuario</b></th>
			<th align="left" width="450"><b>Nombre Usuario</b></th>            
       </tr>
	<%
	...
	%>	
		<tr id="tablerow<%=i%>" name=t1 style="CURSOR: hand" onclick="changeColor(this)" class="tablaDetallev2Body">
			<td align="left" id="tablecol2<%=i%>" width="25%" ><%=values.get("userId")%></td>
			<td align="left" id="tablecol1<%=i%>" width="50%" ><%=values.get("userName")%></td>
       </tr>
    <%
     			values.clear();
			}
