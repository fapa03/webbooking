...
function getRow(){
	...
	if(rowidflag=='true'){
		...
		var oldSelectedDestinationcode = window.opener.document.forms[0].destinationsitecode.value;

	
		
		window.opener.document.forms[0].destinationsite.value = obj2.innerHTML;
		window.opener.document.forms[0].destinationsitecode.value = obj1.innerHTML;		
...
<div id="datadiv" style="BACKGROUND-COLOR: #cedee9;OVERFLOW:auto;WIDTH:100%;HEIGHT: 92pt">
