...
function getRow(){
	...
	if(rowidflag=='true'){
		...
		if(window.opener.document.forms[0].content==null)
		{
		...
		window.opener.document.forms[0].orgiencolonia1.value = u14.innerHTML;
		window.opener.document.forms[0].orgiencolonia2.value = u16.innerHTML;
		//window.opener.document.forms[0].zipCode.value = zip.innerHTML;		
		if(window.opener.document.forms[0].orgionaddresscode!=null)
		window.opener.document.forms[0].orgionaddresscode.value=document.forms[0].addressCode[rownum].value;	
		else
		window.opener.document.forms[0].orgioncode.value=document.forms[0].addressCode[rownum].value;	
		window.opener.document.forms[0].orgien2.value=document.forms[0].am_drnr[rownum].value;
		window.opener.document.forms[0].orgien1.value=document.forms[0].am_strt_name[rownum].value;
		
		window.opener.document.forms[0].orgientelefono.value=document.forms[0].am_phono1[rownum].value;
		
		window.opener.document.forms[0].orgienrfc.value=document.forms[0].rfc.value;
...
function getRow1(){
	...
	if(rowidflag=='true'){
		...
		window.opener.document.forms[0].orgiencolonia2.value=u16.innerHTML;
		//window.opener.document.forms[0].zipCode.value=zip.innerHTML;			
		//window.opener.document.forms[0].orgiennombre.value=window.opener.document.forms[0].refClientName.value;
		//alert(document.forms[0].rfc.value);
		window.opener.document.forms[0].orgienrfc.value=document.forms[0].rfc.value;
		
		if(window.opener.document.forms[0].orgionaddresscode!=null)
		window.opener.document.forms[0].orgionaddresscode.value=document.forms[0].addressCode.value;
		else
		window.opener.document.forms[0].orgioncode.value=document.forms[0].addressCode.value;	
		window.opener.document.forms[0].orgien2.value=document.forms[0].am_drnr.value;
	
		window.opener.document.forms[0].orgien1.value=document.forms[0].am_strt_name.value;
		
		window.opener.document.forms[0].orgientelefono.value=document.forms[0].am_phono1.value;				
...
<table align="left" width="100%" border=1 cellspacing="1"
	cellpadding="1" class="tablaDetallev2" >
	<tr>
	...
	<logic:present name="clientrfc">
		<input type="hidden" name="rfc"
			value=<%=request.getAttribute("clientrfc")%>>
	</logic:present>
	<% 
	...
	<tr id="tablerow<%=i%>" name=t1 style="CURSOR: hand"
		...
		<input type=hidden name="am_suitno"
			value="<%=values.get("AM_SUIT_NO")%>">
		<input type=hidden name="am_floorno"
			value="<%=values.get("AM_FLOR_NO")%>">
