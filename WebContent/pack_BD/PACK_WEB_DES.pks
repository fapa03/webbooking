CREATE OR REPLACE PACKAGE SIPDES."PACK_WEB" IS
  ...
  FUNCTION fun_ftch_clnt_user_name(user_id VARCHAR2) RETURN VARCHAR2;--AAP20140126
  ...
  FUNCTION FUN_DISP_ADDL_SRVC_km(CLNT_id VARCHAR2,TRIF_SLAB VARCHAR2,ORGN_BRNC VARCHAR2, km_Dist NUMBER) RETURN VARCHAR2;
  ...
  FUNCTION FUN_FTCH_WT_VOL_AMNT_KM(clnt_id VARCHAR2, orgn_brnc VARCHAR2,km_dist NUMBER,trif_slab VARCHAR2, refr_serv_id VARCHAR2, serv_id VARCHAR2,weight NUMBER,VOLUME NUMBER) RETURN NUMBER;
...
PROCEDURE PRO_INSRT_WEB_BOK_SRVC_ITEM_NE(GUIA_NO IN VARCHAR2,SRVC IN VARCHAR2,REFR_SRVC IN VARCHAR2,
 ...
 PROCEDURE PRO_INSRT_WEB_BOK_SRVC_NEW(GUIA_NO IN VARCHAR2,SRVC IN VARCHAR2,DISC IN NUMBER,
  ...
  FUNCTION fun_ftch_trif_exist_km(clnt_id VARCHAR2, km_dist NUMBER, trif_type VARCHAR2) RETURN VARCHAR2;--AAP05
  ...
  FUNCTION fun_ftch_trif_amnt_KM(clnt_id VARCHAR2, orgn_brnc VARCHAR2, km_dist NUMBER,
        trif_type VARCHAR2, refr_serv_id VARCHAR2, serv_id VARCHAR2) RETURN NUMBER;
  FUNCTION fun_ftch_trif_amnt_C(clnt_id VARCHAR2, orgn_brnc VARCHAR2,dest_brnc VARCHAR2,trif_slab VARCHAR2, refr_serv_id VARCHAR2, serv_id VARCHAR2,weight NUMBER,VOLUME NUMBER) RETURN NUMBER;
  FUNCTION fun_ftch_trif_amnt_C_KM(clnt_id VARCHAR2, orgn_brnc VARCHAR2,km_dist NUMBER,trif_slab VARCHAR2, refr_serv_id VARCHAR2, serv_id VARCHAR2,weight NUMBER,VOLUME NUMBER) RETURN NUMBER;        
  FUNCTION fun_ftch_trif_amnt_new(clnt_id VARCHAR2,dest_brnc VARCHAR2, serv_id VARCHAR2, tarifa VARCHAR2) RETURN NUMBER;
  FUNCTION fun_ftch_trif_amnt_new_brnc(clnt_id VARCHAR2,dest_brnc VARCHAR2, serv_id VARCHAR2, tarifa VARCHAR2, orgn_brnc VARCHAR2) RETURN NUMBER;
  FUNCTION fun_ftch_trif_amnt_new_KM(clnt_id VARCHAR2, km_dist NUMBER, serv_id VARCHAR2, tarifa VARCHAR2) RETURN NUMBER;
...
VLUM number, PESO_REAL NUMBER, PESO_VOLUMETRICO NUMBER,  tariff_id OUT varchar2,  clnt_dis out number , VEAD OUT NUMBER, VRAD OUT NUMBER) RETURN NUMBER;
FUNCTION fun_ftch_trif_amnt_brnc_SEG(clnt_id VARCHAR2,dest_brnc VARCHAR2, serv_id VARCHAR2, orgn_brnc VARCHAR2, qty NUMBER, srvc_itmid VARCHAR2, WEIGHT number, VLUM number,
PESO_REAL NUMBER, PESO_VOLUMETRICO NUMBER, tariff_id OUT varchar2,  clnt_dis out number , VEAD OUT NUMBER, VRAD OUT NUMBER) RETURN NUMBER;
 PROCEDURE PRO_INSRT_WEB_BOK_SRVC_CIA(GUIA_NO IN VARCHAR2,SRVC IN VARCHAR2,DISC IN NUMBER,
                                  ...
                                  CRETD_ON IN DATE,CRETD_BY IN VARCHAR2,
                                  MODI_ON IN DATE,MODI_BY IN VARCHAR2,
                                  STUS_FLAG IN VARCHAR2,DISC_SLAB IN VARCHAR2, CMPY_ID IN VARCHAR2);
  PROCEDURE PRO_INSRT_WEBBOKSRVCITEM_CIA (GUIA_NO IN VARCHAR2,SRVC IN VARCHAR2,REFR_SRVC IN VARCHAR2,
                                         ...
                                         SLAB IN VARCHAR2,
                                         WEIGHT IN NUMBER,VOLUME IN NUMBER,
                                         DOCU_TYPE IN VARCHAR2,GUIA_TYPE IN VARCHAR2,  CMPY_ID IN VARCHAR2);
END;
/