<%@ page language="java" import="java.io.*,java.util.*,bean.Global" %><%
   ...
   //AAPP//System.out.println("Coming jsp");
...
//   String printfilename = global.printfilename;
  String printfilename=request.getParameter("file"); 
   ...
   try{
	...
	is = null;
		...
		try {
			...
			System.out.println("DONWLOADIMPORTFILEGUIA CATCH 2");
		}
		try {
			if(is != null) {
				is.close();
			...
			System.out.println("DONWLOADIMPORTFILEGUIA CATCH 3");
		}
		try {
			if(os != null) {
				os.flush();
			...
			System.out.println("DONWLOADIMPORTFILEGUIA CATCH 4");
		}
	}
