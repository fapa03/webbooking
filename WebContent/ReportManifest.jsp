		...
		<div align="right"><font color="#004040">Inicial</font></div>
			...
			<tr>
	    		...
	    		<td align="center" colspan="2">
	    			<a class="fa fa-download buttonMedium tagButton" onclick="alert('Fuera de servicio por mantenimiento.');//if (chkDate()) { document.forms[0].action='manifestreport.do'; document.forms[0].submit() }" >Descargar</a>
