...
//    $.ajax("/glp/resources/js/printZPL/assets/signing/digital-certificate-20192022.txt").then(resolve, reject);
    //Alternate method 1 - anonymous
//        resolve();

    //Alternate method 2 - direct
    resolve("-----BEGIN CERTIFICATE-----\n" +
            "MIIFWTCCA0OgAwIBAgIENjYzOTALBgkqhkiG9w0BAQUwgZgxCzAJBgNVBAYTAlVT\n" +
            "MQswCQYDVQQIDAJOWTEbMBkGA1UECgwSUVogSW5kdXN0cmllcywgTExDMRswGQYD\n" +
            "VQQLDBJRWiBJbmR1c3RyaWVzLCBMTEMxGTAXBgNVBAMMEHF6aW5kdXN0cmllcy5j\n" +
            "b20xJzAlBgkqhkiG9w0BCQEWGHN1cHBvcnRAcXppbmR1c3RyaWVzLmNvbTAeFw0x\n" +
            "OTA3MDgwNDAwMDBaFw0yMjA3MDkwNDAwMDBaMIIBIzELMAkGA1UEBgwCTVgxEDAO\n" +
            "BgNVBAgMB1NJTkFMT0ExEzARBgNVBAcMCkxPUyBNT0NISVMxPzA9BgNVBAoMNkNP\n" +
            "T1JESU5BRE9TIERFIENBUkdBIFBBUVVFVEVYUFJFU1MsIFMuIERFIFIuTC4gREUg\n" +
            "Qy5WLjE/MD0GA1UECww2Q09PUkRJTkFET1MgREUgQ0FSR0EgUEFRVUVURVhQUkVT\n" +
            "UywgUy4gREUgUi5MLiBERSBDLlYuMT8wPQYDVQQDDDZDT09SRElOQURPUyBERSBD\n" +
            "QVJHQSBQQVFVRVRFWFBSRVNTLCBTLiBERSBSLkwuIERFIEMuVi4xKjAoBgkqhkiG\n" +
            "9w0BCQEMG21kaW1hc0BwYXF1ZXRleHByZXNzLmNvbS5teDCCASAwCwYJKoZIhvcN\n" +
            "AQEBA4IBDwAwggEKAoIBAQCxKWphMjKcp27Rwi/q/Qb14+5zzK7EZnUZnXymknFg\n" +
            "wunqIob3/OX7XrHzNpThC8McLnMlx6bA6286jVE1u54f61UAoRaUDr7madVrmyUg\n" +
            "Xn+TDOFe3n7m+LjP4dMSrd6CvSYd7G4Hqldlrl20IDpeGpQdgT0UnVnESvZFyp2B\n" +
            "z7K2tQURtAQkmhpJIPWPBTfwFJpZ9Uc9xtLRa8gFJiRpozwDmyNDP7ZE2NCnVct/\n" +
            "jwN8GXe129/LsB0weI0LFm7grNdyaRzpzHgWancHtG/r/qdeIY/WPVPB3aFGFbJU\n" +
            "Ohxz2EzqJ3ogQCDLnkqFyP+ExNBhicmqE/E1ij1uWAoLAgMBAAGjIzAhMB8GA1Ud\n" +
            "IwQYMBaAFJCmULeE1LnqX/IFhBN4ReipdVRcMAsGCSqGSIb3DQEBBQOCAgEAMk7u\n" +
            "tvPwux32hwNuxrA7zgELBXodbTN2HPBO12ghX4gLBFrQEmDfC17+HrVLv9dfGhUs\n" +
            "jNWfVaH9MdAI6OMazBjuqpkYr6lD9hxdo+iwt/Td597ROYobgdo6TnxZzPe6M8Bv\n" +
            "nNEzIUW8+ospkI+tS5kt5+VFqEz2GoO4JOOcOnkEElojosLleOvUKH53s/OyGfpa\n" +
            "bCLTKs7/81xClmEG0EUJhRCECz0cX5B6jtep+rMq6QNJOV+5y4fgPVVUDI3+xtFy\n" +
            "tFExgGhS59aJh/350ow66KgD4gTyV7w+eczO49AkMblMTAIAGYfu3whn4oujg0oM\n" +
            "QC3JDAy42XuTq+6JNj7resSPnItM7EkEDe4OoPZBL1fIEHWDzgzLiLhGYLeAu7xA\n" +
            "wYzQjFF1oGka9D5y+qXiq85iRL9mSn6a6eGJMuuP/CABIu63zorM6hZ6mNn9oIfW\n" +
            "NAdff72CXECiuy2C9X6tAl0Ya/AaoNiIVep/bpgSMkSJmDBlbDFUXlXJOve8ITSY\n" +
            "fhsa5VltfoNpI0d3LTPNxVsjdVDimVXoFC9V9YqggzXW/eGsMdXiVHwzy0/cvnhs\n" +
            "HU+B90PA6BKt5mICtMbfNRGlbVzfq3nRPw8cUnpV/ct6NhQS6yWgY7MNxIp9nr5N\n" +
            "CUFMmGoFe2fUxLxIZF333eRWiGzZceR7QUjZljk=\n" +
            "-----END CERTIFICATE-----\n" +
...
//    resolve("-----BEGIN CERTIFICATE-----\n" +
//            "MIIE2TCCAsOgAwIBAgIEMTk0NTALBgkqhkiG9w0BAQUwgZgxCzAJBgNVBAYTAlVT\n" +
//            "MQswCQYDVQQIDAJOWTEbMBkGA1UECgwSUVogSW5kdXN0cmllcywgTExDMRswGQYD\n" +
//            "VQQLDBJRWiBJbmR1c3RyaWVzLCBMTEMxGTAXBgNVBAMMEHF6aW5kdXN0cmllcy5j\n" +
//            "b20xJzAlBgkqhkiG9w0BCQEWGHN1cHBvcnRAcXppbmR1c3RyaWVzLmNvbTAeFw0x\n" +
//            "NjA4MTcyMTAwMDBaFw0xOTA4MTgyMTAwMDBaMIGkMQswCQYDVQQGDAJNWDEQMA4G\n" +
//            "A1UECAwHU2luYWxvYTETMBEGA1UEBwwKTG9zIE1vY2hpczEWMBQGA1UECgwNUGFx\n" +
//            "dWV0ZXhwcmVzczEWMBQGA1UECwwNUGFxdWV0ZXhwcmVzczEWMBQGA1UEAwwNUGFx\n" +
//            "dWV0ZXhwcmVzczEmMCQGCSqGSIb3DQEJAQwXanVhbl9jYXJlc3RAaG90bWFpbC5j\n" +
//            "b20wggEgMAsGCSqGSIb3DQEBAQOCAQ8AMIIBCgKCAQEAyFYUEX4URh86tHEg/VLh\n" +
//            "2JBmMDBPO8vuz3fsnIDAnfR2KnI1BBuwWYm105kS7oQp7rzskFtWtoXVG1Juvben\n" +
//            "wfYODhj7L7U216Zvx3f8gRaeng/2xiELQHW16PPb5S9jWVRg5GcDMskeiosMI095\n" +
//            "nyx1jxZ21pbxIUjXXK/cQ7wK1FmevEThqkG0JJKe6VC0IW3dBHHFZzcslhH9dieR\n" +
//            "u/S71c33F3MImOlzx1QCI07nv85HUvQD+gSgbefhR4KEANsCD7H4obHpK+lUgn7b\n" +
//            "o6sosIPPnlJqp0xyhV2ptJrNLN+ViLq9uD2Ot8lIYSeWSl19N0NiFi81+0Eio5wp\n" +
//            "HwIDAQABoyMwITAfBgNVHSMEGDAWgBSQplC3hNS56l/yBYQTeEXoqXVUXDALBgkq\n" +
//            "hkiG9w0BAQUDggIBADF0zcHpBMqgbvAA6rJE1qHvM+XtKZUsUE1Yhj8bEvVn6ckL\n" +
//            "DW2Ald6kj2TARDM2DZBIVmrx2u9AM3Eg8SqhPAlsRUFaxTegksc9CLT3Q8DigbL+\n" +
//            "Nif0Qt3EQILuvqJBIayd/oYbClgIDfZIaXUDWFlb/74t3pg+YsE3JWAurV32IWnf\n" +
//            "OT4qbVfG2IoALQYBm7ju3eu3aQvtcm1TKQMnNIN1Tv7tjpi1V8tS1BZlVzmhL76c\n" +
//            "onJttE1hKVM9+vVsly5FkNxh0AJ+6YLJJlByW3sV9vfPAXi0VqpKxqRsTbTd1fnB\n" +
//            "VGTTdJA1lltRjb4A1pxM0KuWXPM7DWwSGGPxjuid1Ya3s5kDyGs0qjs2zBKUJQOa\n" +
//            "puO7hQL2N4kHH5gG0e0GZEcLwEjLu9GHkFq4CITNuh+cbDBBN6ka3Ntk5U5PfCJ5\n" +
//            "10SNSjwt6uGbpT632c//1WUK3Lkx2xZbsg5oaPKlN7tG461DrwFNyVNzd4hCa2QN\n" +
//            "Fl2iYqyuAXtZv+pDQwu+FTPlqeSS1ia+MqLUwdUv8IcZvkeRkGTufHMraWAhE6Ik\n" +
//            "DFNZMBnGI6AidptlE/YWEkyUdSmZNG5ZBkeFdVCJn9zwGhk+ScXntIFLSCDOtYUe\n" +
//            "6bDoKDdFAL0pFxBE3JVTUVTNMDcMsDgcyazuAXJ9y9SQNjU4PUPnEU4ymzcm\n" +
//            "-----END CERTIFICATE-----\n" +
//            "--START INTERMEDIATE CERT--\n" +
//            "-----BEGIN CERTIFICATE-----\n" +
//            "MIIFEjCCA/qgAwIBAgICEAAwDQYJKoZIhvcNAQELBQAwgawxCzAJBgNVBAYTAlVT\n" +
...
//            $.ajax("/secure/url/for/sign-message?request=" + toSign).then(resolve, reject);
        ...
        $.ajax("/glp/MessageSigner?request=" + toSign).then(resolve, reject);
        //console.log("SignaturerPromise11");  
...
//   return function(resolve, reject) {
//        alert("jkhujkhl");
//      $.post("/glp/resources/js/printZPL/assets/signing/sign-message.java", {request: toSign}).then(resolve, reject);
//   };
//});
...
//    
//    function excecuteStartConnection(){
//        startConnection();
//        return true;
//    } 
//    
//    function excecuteDefaultPrinter(){
...
function goToPrintGroupping(printer) {
    ...
    if (zplInput !== "") {
        ...
        displayError("Seleccione al menos una guía para imprimir.");
    }
}
...
function handleConnectionError(err) {
    ...
    if (err.target != undefined) {
        if (err.target.readyState >= 2) { //if CLOSING or CLOSED
            ...
            setmensajeImpresionStatus("El programa QZ Tray esta cerrado, inicielo para continuar");
        } else {
            setmensajeImpresionStatus("Error al iniciar programa QZ Tray");
            displayError("A connection error occurred, check log for details");
            console.error(err);
        }
    } else {
        setmensajeImpresionStatusError("El programa QZ Tray esta cerrado, inicielo para continuar");        
        displayError(err);
    }
}
...
//        PF('dlgImpresionError').show(); 
    if ((error.message.indexOf(search1) > -1) || (error.message.indexOf(search2) > -1) || (error.message.indexOf(search3) > -1)) {
//              $("#iconStatusPrinter").removeClass("displayNone");  
//              $("#form\\:solicitudes\\:btnPrint").addClass("ui-state-disabled");  
//              $("#form\\:solicitudes\\:btnPrint").attr("disabled" , "disabled");    
        $("#msjeErrorImpresion").html("Error: verifique el estatus del programa de impresión <strong>QZ Tray</strong>. <br>\n\
...
function imprimirZebra(xhr, status, args) {
    var print = eval('(' + args.print + ')');
    if (typeof (print) !== "undefined") {
        if (print === "Y") {
//            sendZebra();
            
            PF('statusDialogImpresion').show();
            terminoStartConnection = false;
            clearInterval(myIntervalImpresion);
            var config = getUpdatedConfig();
            setmensajeImpresionStatus("Iniciando conexión...");
            ...
            myIntervalImpresion = setInterval(function () {
                if (terminoStartConnection) {
                    clearInterval(myIntervalImpresion);
                    setmensajeImpresionStatus("Asignando impresora...");
                    ...
                    qz.printers.find().then(function (data) {
                        ...
                        if (defaultPrinter !== "") {
                            setmensajeImpresionStatus("Preparando impresion...");
                            imprimirMaryKay(defaultPrinter, true, config);
                        }else{
                            alert("No se encontro la impresora: " + printer);
                            PF('statusDialogImpresion').hide();
                        }
                    }).catch(displayError);
                }
            }, 1000);
...
function imprimirMaryKay(query, set, config) {
    qz.printers.find(query).then(function (data) {
        if (set) {
            setPrinter(data);
            var zpLLabel = $("#form\\:txtZPLLabel").html();
            ...
            '00000000000000000000',
                ...
                qz.print(config, printDataLabel).catch(displayError);
                setmensajeImpresionStatus("Se envio impresion a..." + data);
                PF('statusDialogImpresion').hide();

                console.log("Se envio impresion a..." + data);
            }else{
                PF('statusDialogImpresion').hide();
                alert("No hay datos para enviar a imprimir");
            }
        }
    }).catch(displayError);
}
...
///Mercado libre
function imprimirZebraImpresionMeli() {
    ...
    myIntervalImpresion = setInterval(function () {
        if (terminoStartConnection) {
            ...
            qz.printers.find().then(function (data) {
                ...
                if (defaultPrinter !== "") {
                    setmensajeImpresionStatus("Preparando impresion...");
                    imprimirMeLi(defaultPrinter, true, config);
                } else { 
                    alert("No se encontro la impresora: " + printer);
                    PF('statusDialogImpresion').hide();
                }
...
function imprimirMeLi(query, set, config) {
    qz.printers.find(query).then(function (data) {
        if (set) {
            setPrinter(data);
            var zpLLabel = $("#form\\:txtZPLLabel").html();
