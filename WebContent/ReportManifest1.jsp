...
function submitReport(){
	if(chkDate1()){		
		if(chkDate2()){			
			document.forms[0].action="manifestreport1.do"
...
<body onload="javascript:document.forms[0].startDate.focus()" class="backgroundStandard">
	<html:form action="manifestreport1">
	<strong class="titleReport">Reporte por fechas</strong>
			<table width="100%" class="tablaDetallev2" border="1" cellspacing="1" cellpadding="1">
			<tr class="" >
  			  <td width="25%"  class="tablaDetallev2Header">
					<div align="right"><font color="#004040">Inicial </font></div>
					</td>
    		<td width="75%" align="center"> 
      				<html:text property="startDate" />(dd/mm/yyyy)</td>
  			</tr>
  			<tr class="tablaDetallev2Header">
  			  <td width="25%" class="tablaDetallev2Header">
					<div align="right"><font color="#004040">Final</font></div></td>
    		<td width="75%" align="center"> 
      				<html:text property="endDate" />(dd/mm/yyyy)</td>
  			</tr>
			<tr>
				<td align="center" width="100%" colspan="2" >
<%-- 					<html:button styleClass="button buttonLarge" property="but" value="Mirar reporte" onclick="submitReport()" /> --%>
					<a class="fa fa-download buttonMedium tagButton" onclick="alert('Fuera de servicio por mantenimiento.');//submitReport()" >Descargar</a>
				</td>
			</tr>
		</table>			
	</html:form>
