...
function submitReport(){
	if(chkDate1()){
		if(chkDate2()){
			document.forms[0].action="manifestreport2.do"
...
function trim(val){
	...
	<html:form action="manifestreport2">
	...
	<strong class="titleReport">Reporte por fechas</strong>
			...
			<tr>
  			  <td width="25%">
					<div align="right"><font color="#004040">Inicial </font></div></td>
...
<%-- 					<html:button styleClass="button buttonLarge" property="but" value="Reporte" onclick="submitReport()" /> --%>
