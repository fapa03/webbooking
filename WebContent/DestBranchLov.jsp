...
function getRow(){
	if(rowidflag=='true'){
		...
		window.opener.document.forms[0].sucursalRef.value = obj2.innerHTML;
		window.opener.document.forms[0].sucursalRef.focus(); 
		window.close();
	}else{
...
<div id="datadiv" style="BACKGROUND-COLOR: #cedee9; HEIGHT: 92pt; OVERFLOW: auto; WIDTH: 100%">
	...
	<% 
		ArrayList result = (ArrayList) request.getAttribute("destBranchRecords"); 
		if(result.size()==0){
	%>
