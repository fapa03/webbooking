...
function submitReport(){
	if(chkDate1()){
		if(chkDate2()){
			document.forms[0].action="clientreport3.do"
...
<html:form action="/clientreport3">
<strong class="titleReport">Reporte por fechas:</strong>
<table  class="tablaDetallev2" border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="25%" align="right">Inicial</td>
    <td width="75%">
		<html:text  property="startDate"/>(dd/mm/yyyy)
	</td>
  </tr>
  <tr>
    <td width="25%" align="right">Final</td>
    <td width="75%">
