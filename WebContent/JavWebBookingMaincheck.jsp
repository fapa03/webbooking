...
<html:form action="/webbookingFileUpload" >
...
<logic:present name="sPwdUpdated" scope="request"> 
	 <logic:equal   name="sPwdUpdated" value="yes" scope="request"> 
	        <table align="center" width="60%" cellspacing="0" cellpadding="0" border="0">
   				<tr>
     				 <td align="center"> <font color="red" size=4 > <bean:message key="password.changed" /> </font> 
    	 			</td>
  				</tr>
    		</table>
	</logic:equal>
...
<table cellspacing="0" cellpadding="0" border="0" align="left">
  ...
  <tr> 
	...
	<html:file property="theFile"/> </div>
	   ...
	   <tr> 
          <td height="17"> 
            <div align="right"><a href="webbookingFileUpload.do">Data File Import & Generate Guia</a></div>
          </td>
        </tr>
		
		<tr> 
          <td height="17"> 
            <div align="right"><a href="webBookinggeneral.do" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ela','','images/elabo_o.gif',1)"><img name="ela" border="0" src="images/elabo_m.gif" width="207" height="25"></a></div>
          </td>
        </tr>
        <tr> 
          <td> 
            <div align="right"><a href="JavGuiaCancellation.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('cancel','','images/cancel_o.gif',1)"><img name="cancel" border="0" src="images/cancel_m.gif" width="218" height="24"></a></div>
          </td>
        </tr>
        <tr> 
          <td> <!-- JavShipmentHistoryLog.jsp -->
            <div align="right"><a href="shipmentHistory.do" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('histori','','images/histori_o.gif',1)"><img name="histori" border="0" src="images/histori_m.gif" width="207" height="25"></a></div>
          </td>
        </tr>
        <tr> 
          <td> 
		       <div align="right"><a href="JavReportMain.jsp" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('informacion','' ,'images/infor_o.gif',1);"><img name="informacion" border="0" src="images/infor_m.gif" width="207" height="25"> </a> </div>
          </td>
        </tr>
...
<logic:present name="loginForm">
  ...
  <logic:equal name="loginForm" property="userValidate" value="validUser">
		...
		<tr> 
          <td> 
            <div align="right"><a href="clientDestinationEntry.do" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('captura','','images/entradaDel_o.gif',1)"><img name="captura" border="0" src="images/entradaDel_m.gif" width="207" height="25"></a></div>
          </td>
        </tr>
   </logic:equal>
   <!-- ended by bala -->
