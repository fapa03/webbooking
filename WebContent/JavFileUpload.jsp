...
function validate()
{
	...
	var file=window.document.forms[0].theFile.value.length;
if( file=='')
	{
...
<html:form action="/webbookingFileUpload" method="post" enctype="multipart/form-data">
<table border="0" width="80%" cellspacing="0" cellpadding="0" bgcolor="#CEDEE9" >
<tr height="20%" >
<td align="center" colspan="2">
<font size="4">Please Locate the File For Uploading</font>
</tr>
...
<tr>
<td align="center" >
<html:submit onclick="return validate();">Upload File</html:submit>
</td>
</tr>
</table>
